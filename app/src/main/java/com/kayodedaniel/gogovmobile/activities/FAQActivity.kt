...
class FAQActivity : AppCompatActivity() {
    ...
    private fun downloadPortalGuide() {
        try {
            // Copies PDF from raw resources to app's cache directory
            ...
            // Ensures file exists before proceeding
            if (!file.exists()) {
            ...
            // Starts PDFViewerActivity and passes the file path
    ...
    //parses the FAQs into each item
    ...
    // reads the text from the raw file
